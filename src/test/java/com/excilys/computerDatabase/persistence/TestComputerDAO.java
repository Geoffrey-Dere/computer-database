...
public class TestComputerDAO {
    ...
    public void testFindByName() {
        assertEquals(computerDAO.findByName(2, 0, "teur").size(), 1);
        assertEquals(computerDAO.findByName(2, 0, "ordi").size(), 2);
        assertEquals(computerDAO.findByName(2, 0, "sdsds").size(), 0);
